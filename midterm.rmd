...
MAYBE WE ALSO CAN COME BACK TO THIS AND DO A LITTLE MORE WITH EXPONENTIATION
_________
...
inundationProbability <- predict(inundationModel, allCalgaryTest, type="response")

hist(inundationProbability)
```
