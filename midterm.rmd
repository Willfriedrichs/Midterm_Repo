...
sacramento_elevation <- raster("https://raw.githubusercontent.com/Willfriedrichs/Midterm_Repo/main/Finalized_Layers/sac_dem_filled.tif")


fishnet <- 
  st_make_grid(sacramento_elevation,
               cellsize = 10000, 
               square = TRUE) %>%         # clips the grid to the chesterBoundary file
  st_sf() %>%
